...
def malloc_doublep(*args):
  return _psrfits_utils.malloc_doublep(*args)
malloc_doublep = _psrfits_utils.malloc_doublep

def free_doublep(*args):
  return _psrfits_utils.free_doublep(*args)
free_doublep = _psrfits_utils.free_doublep
...
def convert2_double_array(*args):
  return _psrfits_utils.convert2_double_array(*args)
convert2_double_array = _psrfits_utils.convert2_double_array

def print_float_array(*args):
  return _psrfits_utils.print_float_array(*args)
print_float_array = _psrfits_utils.print_float_array

def print_double_array(*args):
  return _psrfits_utils.print_double_array(*args)
print_double_array = _psrfits_utils.print_double_array
